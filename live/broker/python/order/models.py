...
from broker.base import OrderType, OrderSide
...
class OrderResponse:
    ...
    @classmethod
    def success_response(cls, order_id: str, client_order_id: Optional[str] = None) -> 'OrderResponse':
    ...
    @classmethod
    def error_response(cls, error_type: OrderErrorType, message: str,
...
class OrderValidationError:
    ...
    def to_response(self, client_order_id: Optional[str] = None) -> OrderResponse:
